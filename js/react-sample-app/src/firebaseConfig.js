...
import { getFirestore, collection, doc, getDoc, getDocs, setDoc, updateDoc, addDoc, query, where } from 'https://www.gstatic.com/firebasejs/12.2.1//firebase-firestore.js';
...
export { db, collection, doc, getDoc, getDocs, setDoc, updateDoc, addDoc, query, where };